...
namespace LuckyStarry.Data.MySQL
{
    ...
    {
        protected internal MySQLUpdateBuilder(MySQLCommandFactory factory) : base(factory) { }
        ...
        public virtual MySQLTableUpdateCommandBuilder Table(Data.Objects.IDbTable table) => new MySQLTableUpdateCommandBuilder(this.factory, this, table);
    }
}
